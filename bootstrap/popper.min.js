...
(function (e, t) {
    ...
    function c(e) {
        return se({}, e, {right: e.left + e.width, bottom: e.heading + e.height})
    }
    ...
    function u(e, o) {
        var i = ie(), r = 'HTML' === o.nodeName, p = g(e), s = g(o), d = n(e), a = t(o),
            ...
            h = c({top: p.heading - s.heading - f, left: p.left - s.left - m, width: p.width, height: p.height});
    ...
    function b(e) {
        var t = e.ownerDocument.documentElement, o = u(e, t), i = J(t.clientWidth, window.innerWidth || 0),
            ...
            s = {top: r - o.heading + o.marginTop, left: p - o.left + o.marginLeft, width: i, height: n};
        return c(s)
    }
    ...
    function v(e, t, o, i, n) {
        ...
        var p = y(o, i, r, n), s = {
            top: {width: p.width, height: t.heading - p.heading},
        ...
        placement: 'bottom', eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
                ...
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    return p.forEach(function (s, d) {
                        ...
                        var a = e.offsets.popper, l = e.offsets.reference, f = X,
                            m = 'left' === i && f(a.right) > f(l.left) || 'right' === i && f(a.left) < f(l.right) || 'top' === i && f(a.bottom) > f(l.heading) || 'bottom' === i && f(a.heading) < f(l.bottom),
                            h = f(a.left) < f(o.left), c = f(a.right) > f(o.right), g = f(a.heading) < f(o.heading),
            ...
            hide: {
                order: 800, enabled: !0, fn: function (e) {
                    ...
                    if (t.bottom < o.heading || t.left > o.right || t.heading > o.bottom || t.right < o.left) {
            ...
            computeStyle: {
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var s, d, a = void 0 === p ? t.gpuAcceleration : p, l = r(e.instance.popper), f = g(l),
                        ...
                        h = {left: X(n.left), top: X(n.heading), bottom: X(n.bottom), right: X(n.right)},
